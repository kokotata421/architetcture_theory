...
これはHomeCollectionDataSourceWrapperの例でViewModelをPresenterに書き換えるのやめた原因と関係しており、HomeCollectionDataSourceWrapperではCollectionViewの選択イベントを`collectionView.rx.itemSelected`を使ってCellViewModelに伝達していますが、これはRxCocoaによってはじめて実現できています。    
