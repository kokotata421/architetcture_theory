...
C
これはHomeCollectionDataSourceWrapperでViewModelをPresenterに書き換えるのやめた原因と関係しているのですが、該当のコードではCollectionViewの選択イベントを`collectionView.rx.itemSelected`とRxCocoaの機能を利用してCellViewModelに伝達しています。  
これは
