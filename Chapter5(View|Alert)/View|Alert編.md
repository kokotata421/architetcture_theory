...
しかしデフォルトのAlertの仕様はこうした個々のアプリ機能と完全に切り離されており、Alertの実装ではそこで表示する文言等細かな情報だけを確認することができます。  
もちろんUIフレームワークの視点からいえばこのようにUIであるAlertと個々のアプリが切り離されているのはおかしなことではありません。  
ただアプリ設計の観点からみるとAlertとアプリ機能の繋がりが見えやすくなるように
