...
わざわざ実例出すまでもなかったかもしれませんが、DataSourceはCollectionViewの内容の表示、もしくは更新を行うためであり、その処理をラップしてViewControllerから宣言的に利用できるようになっていればDataSourceは基本的な役割を果たせていると思います。  はCollectionViewの内容の表示、もしくは更新を行うためであり、その処理をラップしてViewControllerから宣言的に利用できるようになっていればDataSourceは役割をしっかりと果たせていると思います。  
わざわざ実例出すまでもなかったかもしれませんが、DataSourceはCollectionViewの内容の表示、もしくは更新を行うためであり、その処理をラップしてViewControllerから宣言的に利用できるようになっていればDataSourceは基本的な役割を果たせていると思います。  
