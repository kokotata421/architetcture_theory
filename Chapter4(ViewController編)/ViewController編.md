...
- プログラム構造においてイベントの入力、出力が強調されるようになる

そしてプログラムも以下のような構造を持つことになるでしょう。  

<img src="https://github.com/kokotata421/architetcture_theory/blob/main/Chapter3(概要)/Images/アーキテクチャの構造.png" alt="アーキテクチャの構造" width=75% > 
