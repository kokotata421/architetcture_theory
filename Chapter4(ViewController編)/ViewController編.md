...
そして画面毎のイベント量の上限はその画面仕様にかかわらず大体決まっており、そのプログラムサイズも行数にして300行程度が上限になるはずです。  
...
そのためある画面のイベントの量が他の画面と比べて極端に少なく100行足らずのサイズになるというようなことはあっても、極端にイベント量が多いことはまずあり得ずほとんどのViewControllerプログラムは200~300行の範囲に収まるはずです。  
