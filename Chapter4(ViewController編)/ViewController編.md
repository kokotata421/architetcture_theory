...
そのような状況を考えても、SwiftUIではなくUIKit/ViewControllerを素材に設計を学んだとしてもそれは必ず何かしらの形でiOS開発の役に立ちますし、そしてSwiftUIよりもより原始的な技術であるUIKitを通して設計を学ぶことで他の開発環境でも柔軟に対応できる応用力が身につくと思います。  
