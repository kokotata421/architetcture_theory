...
そのような状況を踏まえても長期的にプログラミング開発を学ぼうと考えているのならば、設計を学ぶ際に直感的でシンプルに記述できるSwiftUIではなく原始的で複雑なUIKit/ViewControllerを素材にすることによって後々そこで得た知見が他のプラットフォーム開発する際に活かせる場面が出てくると思います。   
