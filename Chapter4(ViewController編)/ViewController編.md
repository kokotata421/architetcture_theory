...
上記のコードを見て見るとViewControllerのコードは機械的で細々としていて、SwiftUIのコードの方が自然言語(英語)的で直感的に何をやっているのか理解しやすいのがわかると思います。<sup>[*4](#footnote4)</sup>   

ViewControllerに慣れている開発者であればそのように機械的で細々としたコードでも経験によって培われた感覚によって触りをみるだけでそれがどのような責務を担っているのか大体理解できるでしょう。  
