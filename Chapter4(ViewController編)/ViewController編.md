...
このように外部に処理を委譲してViewControllerをコンパクトにしてもアプリ全体のコード量が減るわけではなく意味がないのでないかと思う人もいるかもしれません。    
しかしViewControllerは間違いなく画面開発の要であり、私は開発者にとってのViewControllerの一義的な役割はその画面全体の機能(イベント)を伝えることにあると思います。    
