...
ただ宣言的なプログラミングも結局は命令的プログラミングによって実装されているため、こうした対称性は形式的な次元においてのみ意味があるということには注意が必要でしょう。<sup>[*3](#footnote3)</sup>    
...
両者のプログラムがどのように違うのかに関しては「[2つのアプリを書き直して見えてきたSwiftUIのよさとつらみポイント](https://engineering.mercari.com/blog/entry/20201216-4043b38af1/)」という記事の冒頭に書かれているコード比較が分かりやすいと思います。(両者を比較する例を本記事内で紹介しようとすると状況設定やコードの説明等それなりの文量になってしまうので割愛します。)  
...
<a name="footnote3">*3</a>: C++とSwiftはプログラミングスタイル(形式的な次元)において比較することには意味がありますが、Swift自体が内部的にはC++で実装されている(基本的には)ためある観点から言えばこれらの比較が意味がないことと同じです。  
