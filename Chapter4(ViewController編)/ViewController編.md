...
しかしViewControllerの開発において、このような基本的な理解は大まかなところでは開発においても助けになりますがあまり具体的ではなく、結局のところの個々のViewControllerを実際にみてみないとどうなっているかはわからない面が大きいという印象を受けます。(例え正しく実装されていたとしても)
