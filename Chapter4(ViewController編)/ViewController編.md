...
## 補論:View以外の責務の委譲
本記事ではViewControllerの多くの責務を外部に委譲すると述べましたが、その具体的な方法についてはView以外特に特別なテクニックを使っているわけでもないので言及はしませんでした。  
...
まず基本的なことから説明すると、CollectionViewのDelegateはViewControllerにおける入力処理、DataSourceは出力処理に当たります。  
