...
しかしViewControllerの開発において上記ような事柄への理解は抽象的な面では役に立ちますが、あまり具体的なガイドラインは示せていないように思います。    
そのため結局のところViewControllerの開発の際には個々のコードを実際にみてみないとどうなっているかはわからない側面が大きいというのがここでの私の主張です。
