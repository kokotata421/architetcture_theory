...
ViewControllerに慣れている開発者であればこのように細々としたコードでも経験によってその触りをみるだけで大体理解できると思います。  
しかしそのような場合でも例えば不具合が生じる等して正確にコードを調査する必要が出てきた際にはその細々したコードを１行１行確認する必要があるため集中力が必要なります。    
