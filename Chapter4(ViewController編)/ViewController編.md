...
しかし実際にはそれ以外にも責務自体が環境によって変化してしまうViewControllerの性質も理解を難しくさせていると思います。  
...
このようにViewControllerの実装内容は状況に応じて変化するためそこから一般的な責務を理解することは難しいのですが、話を一歩広げると、それは設計をしっかりと理解するためにはコードではなく理論を学ぶ必要があるということです。  
